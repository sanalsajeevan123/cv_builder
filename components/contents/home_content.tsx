...
const HomeContents=()=>{
    ...
    return(
        <div className="w-full flex flex-col items-center justify-center">
           ...
           <button onClick={()=>context.handleCurrenrPosition('resume-templates')} className="py-2 px-4 rounded-md hover:bg-gradient-to-tl bg-gradient-to-br from-yellow-400 to-orange-600 text-white">Get Started</button>
        </div>
    )
}
